function FFT_DEMO__CAMERA_MAN_low_freq_GAUSSIAN( fn )
FS          = 24;       % Font Size
FFT_RADIUS  = 16;
    ...
    im_fft          = im_fft     .* big_gaussian;
    im_fft_mag      = im_fft_mag .* big_gaussian;
    
    fig3 = figure('Position', [10 200 1024 768]);
    imagesc( log( im_fft_mag ) );
    colormap( gray(256) );
    title( 'Low Frequencies that remain after multiplying by Gaussian in Freq. Domain ', 'FontSize', FS );
    axis image;

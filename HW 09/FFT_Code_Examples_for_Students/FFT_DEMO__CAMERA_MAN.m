function FFT_DEMO__CAMERA_MAN()
FS          = 24;
FFT_RADIUS  = 16;

    im_space    = imread( 'cameraman.tif' );
    ...
    % Generate figure for the midterm:
    im_for_mt2  = log( im_fft_mag );
    mmax        = max( im_for_mt2(:) );
    im_out      = im_for_mt2 / mmax;
    
    imwrite( imresize(im_out,16), 'AAAA___FIG_OF_FFT_of_CAMERAMAN.jpg', 'Quality', 98 );
